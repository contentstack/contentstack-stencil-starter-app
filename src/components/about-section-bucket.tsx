...
function bucketContent(bucket, index) {
  return (
    <div class="mission-content-section" key={index}>
      {bucket.icon && <img class="mission-icon" src={bucket.icon.url} alt="art work" />}
...
export default function AboutSectionBucket(props) {
  ...
  return (
    <div class="member-main-section">
      <div class="member-head">{sectionWithBuckets.title_h2 && <h2>{sectionWithBuckets.title_h2}</h2>}</div>
